...
public class Schedules {
    ...
    public Schedules(String scheduleId, String providerId, String requestId, String tripCode, String departurePoint, String arrivalPoint, Date departureDatetime, int estimatedTravelTime, int seatCapacity, int trainCarNumber, BigDecimal seatPrice, String notes, String status) {
