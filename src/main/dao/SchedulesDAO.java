    ...
    public ArrayList<Schedules> selectAll() {
        ...
        try {
            ...
            while(rs.next()) {
                ...
                Schedules s = new Schedules(scheduleId, providerId, tripCode, departurePoint, arrivalPoint, departureDatetime, estimatedTravelTime, seatCapacity, seatPrice, notes);
                result.add(s);
            }
    ...
    public Schedules selectById(Schedules t) {
        ...
        try {
            ...
            while(rs.next()) {
                ...
                result = new Schedules(scheduleId, providerId, tripCode, departurePoint, arrivalPoint, departureDatetime, estimatedTravelTime, seatCapacity, seatPrice, notes);
                break;
            }
    ...
    public ArrayList<Schedules> selectFromProviderId(String provider_id) {
        ...
        try {
            ...
            while(rs.next()) {
                ...
                Schedules sc = new Schedules(scheduleId, providerId, tripCode, departurePoint, arrivalPoint, departureDatetime, estimatedTravelTime, seatCapacity, seatPrice, notes);
                result.add(sc);
            }
